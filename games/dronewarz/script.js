...
droneBody('#32cd32',drx+Math.random()*40-20,dry+Math.random()*40-20,'#32cd80');
droneBody('#32cd80',drx+Math.random()*40-20,dry+Math.random()*40-20,'#32cd32');
...
droneBody('#32cd32',drx+Math.random()*20-10,dry+Math.random()*20-10,'#32cd80');
} else {
